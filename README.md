...
<details>
<summary>AI 연결 · 통합판에 포함</summary>

통합판에는 Codex 등 외부 AI가 Morupixel의 문서·레이어·텍스트·도형·보정·저장 도구를 호출하는 로컬 연결 기능이 들어 있습니다. 앱에서 **AI 연결 → 로컬 연결 켜기**를 선택하고 MCP 서버로 `Morupixel.exe --mcp`를 등록합니다. Morupixel에 API 키를 입력할 필요는 없습니다.

[MCP·Codex 설정과 PowerShell 사용 안내](docs/AI_CONNECTION.md)

</details>

[작업 통합·배포 규칙](docs/INTEGRATION.md) · [사용·개발 안내](https://github.com/catsony5-web/compositor-windows/blob/main/docs/GUIDE.md) · [검증 기록](docs/VALIDATION.md) · [MIT 라이선스](LICENSE)
